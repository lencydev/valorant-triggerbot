...
impl Default for Settings {
  fn default () -> Self {
    Self {
      ...
      color_tolerance: 70,
      trigger_delay: 0,
      selected_resolution: Resolution { width: 1920, height: 1080 },
    }
  }
}
...
impl Triggerbot {
  ...
  pub fn get_available_resolutions (&self) -> Vec<Resolution> {
    vec![
      Resolution { width: 2560, height: 1440 },
      Resolution { width: 1920, height: 1080 },
      Resolution { width: 1680, height: 1050 },
      Resolution { width: 1600, height: 1024 },
      ...
      Resolution { width: 1152, height: 864 },
  ...
  fn is_target_color_present (&self) -> bool {
    ...
    let (width, height) = (self.settings.selected_resolution.width, self.settings.selected_resolution.height);
